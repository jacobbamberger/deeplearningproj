...
class SiameseNet(BaseNet):
    ...
    def __init__(self, nb_hidden_subnet=200, nb_hidden_full=200, is_siamese=True):
        super().__init__()

        self.subnet = SubNet(nb_hidden_subnet) # Does the preprocessing of the images to guess the classes
