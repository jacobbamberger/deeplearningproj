...
class FullNet(nn.Module):
    ...
    def __init__(self, nb_hidden_siamese, nb_hidden):
        super().__init__()

        self.subnet = SiameseSubNet(nb_hidden_siamese) # Does the preprocessing of the images to guess the classes
...
class SiameseSubNet(nn.Module):
    ...
    def __init__(self, nb_hidden, nb_out_1=4, nb_out_2=8):
        ...
        self.bn1 = nn.BatchNorm2d(nb_out_2)
